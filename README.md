...
La landing está optimizada para motores de búsqueda:

### ✅ Implementado

- **Meta tags completos**: Title, description, keywords optimizados
- **Open Graph**: Facebook, WhatsApp, LinkedIn preview perfecto
- **Twitter Cards**: Preview optimizado para Twitter/X
...
- **Alt texts**: Todas las imágenes tienen descripción
...
- [ ] **Favicon**: Agregar `/public/favicon.ico` (16x16, 32x32, 48x48)
- [ ] **Dominio**: Actualizar `https://bonnilda.com` en todos los metadatos
- [ ] **Google Search Console**: Verificar propiedad y enviar sitemap
- [ ] **Google Analytics**: Implementar tracking (opcional)
- [ ] **Redes sociales**: Actualizar URLs en StructuredData.tsx
- [ ] **Contacto**: Actualizar teléfono y email reales

### 🎯 Keywords Target

- Bombones artesanales
- Bombones de fruta
- Dulces artesanales Buenos Aires
- Bombones sin conservantes
- Reventa mayorista bombones
- Golosinas naturales Argentina
