...
import { SOCIAL_MEDIA, PHONE_NUMBER, EMAIL, LOCATION } from '@/constants/contact'
        ...
        <div className="md:hidden space-y-6 mb-8">
          <div className="text-center">
            ...
            <div className="space-y-2 text-sm text-white/70">
              <p>📱 WhatsApp: {PHONE_NUMBER.display}</p>
              <p>✉️ {EMAIL}</p>
            </div>
          </div>
        ...
        <div className="hidden md:grid md:grid-cols-12 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-white/80 text-base mb-6 leading-relaxed">
              ...
              Cada bombón está hecho a mano con frutas seleccionadas y mucho amor en {LOCATION.displayShort}.
            </p>
            ...
            <div className="space-y-3 mb-6">
              <a 
                ...
                className="flex items-center gap-3 text-white/70 hover:text-accent-peach transition-colors group"
              >
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-sm">WhatsApp: {PHONE_NUMBER.display}</span>
              </a>
              <a
                href={`mailto:${EMAIL}`}
                className="flex items-center gap-3 text-white/70 hover:text-accent-peach transition-colors group"
              ...
              <div className="flex items-center gap-3 text-white/70">
                ...
                <span className="text-sm">{LOCATION.displayShort} 🇦🇷</span>
              </div>
            </div>
