          ...
          >
            ...
            <div className="max-w-2xl mx-auto space-y-6 relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <a 
                  href={SOCIAL_MEDIA.whatsapp.urlWithMessage('Hola! Me interesa revender bombones Bonnilda. ¿Podrían enviarme info sobre precios mayoristas? 🍑')}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => analytics.trackWhatsAppClick('mayoristas')}
                >
                  <Button 
                    variant="secondary" 
                    size="lg"
                ...
                <a href="#contacto">
                  <Button 
                    variant="ghost" 
                    size="lg" 
                    className="text-white border-white/30 hover:bg-white/20 hover:border-white/50 w-full sm:w-auto"
                  >
